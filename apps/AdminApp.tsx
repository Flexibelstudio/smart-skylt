...
const MainContent: React.FC = () => {
  ...
  const handleBack = useCallback(() => {
    ...
    if (isDirty) {
        setConfirmState({
            ...
            message: "Du har ändringar som inte har sparats. Är du säker på att du vill gå tillbaka och förlora dina ändringar?",
            onConfirm: () => {
                setIsDirty(false);
                ...
                if (currentPage === Page.DisplayScreenEditor) {
                    ...
                    setPostToEdit(null);
                } else if (currentPage === Page.CustomPageEditor) {
  ...
  const handleSignOut = () => {
    setConfirmState({
        ...
        title: "Logga ut",
        message: isDirty 
          ? "Du har osparade ändringar. Om du loggar ut kommer dina osparade ändringar att gå förlorade. Är du säker på att du vill logga ut?"
