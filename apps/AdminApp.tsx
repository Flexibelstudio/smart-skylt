...
import { Page, CustomPage, DisplayScreen, DisplayPost, Organization, PostTemplate, Tag } from '../types';
...
const AdminContent: React.FC = () => {
    ...
    const handleUpdateDisplayScreens = useCallback(async (orgId: string, screens: DisplayScreen[]) => {
        ...
        // Only update screens that have changed to avoid overwriting recent changes if possible
    ...
    const renderPage = () => {
        switch (page) {
            ...
            case Page.DisplayScreenEditor:
                ...
                // Use local state version to ensure we have the latest
            ...
            default:
                // Fallback similar to SuperAdmin
