...
// NEW: A structured representation for the AI image prompt builder.
export interface StructuredImagePrompt {
  ...
  // FIX: Added mood and lighting to match component usage
  mood?: string;
  lighting?: string;
}

// NEW: A type for AI-generated image variants associated with a post.
...
// FIX: Added missing InstagramStory type definition.
...
// NEW: For tracking long-running video generation operations.
