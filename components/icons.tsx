...
export const ToggleSwitch: React.FC<{
  ...
  disabled?: boolean;
    ...
    <label className={`flex items-center justify-between w-full p-2 rounded-lg transition-colors ${disabled ? 'cursor-not-allowed opacity-50' : 'cursor-pointer hover:bg-gray-500/10'}`}>
...
// A compact version of the toggle switch without a label, for inline use.
export const CompactToggleSwitch: React.FC<{
  checked: boolean;
  onChange: (checked: boolean) => void;
  disabled?: boolean;
}> = ({ checked, onChange, disabled }) => {
  // useId is used to ensure the label is correctly associated with the input, which is important for accessibility.
  ...
  return (
    <label htmlFor={uniqueId} className="relative inline-flex items-center cursor-pointer">
      <input 
        ...
        disabled={disabled}
      />
      <div className="w-14 h-8 bg-gray-300 dark:bg-gray-600 rounded-full peer-checked:bg-primary transition-colors peer-disabled:opacity-50 peer-disabled:cursor-not-allowed"></div>
      <div className="absolute left-1 top-1 bg-white w-6 h-6 rounded-full shadow-md transition-transform peer-checked:translate-x-6 peer-disabled:cursor-not-allowed"></div>
    </label>
  );
};
...
export const CampaignIcon: React.FC<{className?: string}> = ({className}) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M10.5 6a7.5 7.5 0 100 12h-3a7.5 7.5 0 00-7.5-7.5V11.25A7.5 7.5 0 0110.5 6z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M14.25 9a3 3 0 013 3v1.25" />
    </svg>
);
...
export const LightBulbIcon: React.FC<{className?: string}> = ({className = "h-6 w-6"}) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 18v-5.25m0 0a6.01 6.01 0 001.5-.189m-1.5.189a6.01 6.01 0 01-1.5-.189m3 7.5a3 3 0 11-6 0 3 3 0 016 0z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M9.75 21a2.25 2.25 0 014.5 0" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 3c-3.75 0-6.75 2.25-6.75 5.25 0 2.44 1.63 4.544 3.93 5.101a.75.75 0 01.42.66v.204a.75.75 0 01-.42.66c-2.3.557-3.93 2.66-3.93 5.101C5.25 18.75 8.25 21 12 21s6.75-2.25 6.75-5.25c0-2.44-1.63-4.544-3.93-5.101a.75.75 0 01-.42-.66v-.204a.75.75 0 01.42.66c2.3.557 3.93-2.66 3.93-5.101C18.75 5.25 15.75 3 12 3z" />
    </svg>
);
...
export const ArrowUturnRightIcon: React.FC<{className?: string}> = ({className = "h-5 w-5"}) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
...
export const TextAlignLeftIcon: React.FC<{className?: string}> = ({className = "h-5 w-5"}) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 6.75h16.5M3.75 12h12m-12 5.25h16.5" />
    </svg>
);

export const TextAlignCenterIcon: React.FC<{className?: string}> = ({className = "h-5 w-5"}) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 6.75h16.5M6.75 12h10.5m-13.5 5.25h16.5" />
    </svg>
);

export const TextAlignRightIcon: React.FC<{className?: string}> = ({className = "h-5 w-5"}) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
...
export const HandThumbDownIcon: React.FC<{className?: string}> = ({className}) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M17.367 6.833c-.806 0-1.533.422-2.031 1.08a9.041 9.041 0 00-2.861 2.4c-.723.384-1.35.956-1.653 1.715a4.498 4.498 0 00-.322 1.672V21a.75.75 0 00.75.75A2.25 2.25 0 0013.5 19.5c0-1.152.26-2.243.723-3.218.266-.558-.107-1.282-.725-1.282H3.374c-1.026 0-1.945-.694-2.054-1.715A12.134 12.134 0 011.5 12c0-1.56.32-3.057.886-4.386.442-1.026 1.283-1.833 2.25-2.288a11.95 11.95 0 012.649-1.285c.388-.082.787-.123 1.187-.123h.375M17.367 6.833l1.07-1.07a.454.454 0 00.639 0l1.07 1.07h3.267a.75.75 0 01.75.75v8.25a.75.75 0 01-.75.75h-2.339a.75.75 0 01-.75-.75v-7.5h-.633z" />
    </svg>
);
...
export const UsersIcon: React.FC<{className?: string}> = ({className}) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 003.741-.479 3 3 0 00-4.682-2.72m-7.5-2.952a4.5 4.5 0 014.5 0m-4.5 0a4.5 4.5 0 00-4.5 0m12 .542a9.094 9.094 0 01-3.741.479a3 3 0 01-4.682-2.72M13.5 4.5a4.5 4.5 0 100 9 4.5 4.5 0 000-9zM13.5 4.5a4.5 4.5 0 11-9 0 4.5 4.5 0 019 0z" />
    </svg>
);
export const ChatBubbleLeftRightIcon: React.FC<{className?: string}> = ({className}) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 8.511c.884.284 1.5 1.128 1.5 2.097v4.286c0 1.136-.847 2.1-1.98 2.193l-3.722.534a.75.75 0 01-.632-.321l-1.056-1.584a3.375 3.375 0 00-2.87-1.442H4.5a1.5 1.5 0 01-1.5-1.5v-6.634c0-1.136.847-2.1 1.98-2.193l3.722-.534a.75.75 0 01.632.321l1.056 1.584a3.375 3.375 0 002.87 1.442h4.5zM20.25 8.511l-3.722-.534a.75.75 0 00-.632.321l-1.056 1.584a3.375 3.375 0 01-2.87 1.442H4.5a1.5 1.5 0 00-1.5 1.5v6.634c0 .828.672 1.5 1.5 1.5h6.035c1.248 0 2.404-.52 3.248-1.442l1.056-1.584a.75.75 0 00.321-.632l.534-3.722c.114-1.037-.52-1.954-1.564-2.193z" />
    </svg>
);
...
export const MoveIcon: React.FC<{className?: string}> = ({className = "h-5 w-5"}) => (
...
export const LayoutTextOnlyIcon: React.FC<{className?: string}> = ({className}) => (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M4 6h16M4 12h16M4 18h10" />
    </svg>
);
export const LayoutImageFullscreenIcon: React.FC<{className?: string}> = ({className}) => (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <rect x="3" y="3" width="18" height="18" rx="2" ry="2"></rect><circle cx="8.5" cy="8.5" r="1.5"></circle><polyline points="21 15 16 10 5 21"></polyline>
    </svg>
);
export const LayoutImageLeftIcon: React.FC<{className?: string}> = ({className}) => (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <rect x="3" y="3" width="18" height="18" rx="2" ry="2"></rect><line x1="12" y1="3" x2="12" y2="21"></line>
    </svg>
);
export const LayoutImageRightIcon: React.FC<{className?: string}> = ({className}) => (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" transform="scale(-1, 1)">
        <rect x="3" y="3" width="18" height="18" rx="2" ry="2"></rect><line x1="12" y1="3" x2="12" y2="21"></line>
    </svg>
);
export const LayoutCollageIcon: React.FC<{className?: string}> = ({className}) => (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const ArrowsPointingInIcon: React.FC<{className?: string}> = ({className = "h-5 w-5"}) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9 4.5v3m0 0h3m-3 0-5.25-5.25M9 19.5v-3m0 0h3m-3 0-5.25 5.25M15 4.5v3m0 0h-3m3 0 5.25-5.25M15 19.5v-3m0 0h3m3 0 5.25 5.25" />
    </svg>
);

export const LayoutImageTopIcon: React.FC<{className?: string}> = ({className}) => (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
