...
import { Organization, DisplayPost, UserData, Tag, PostTemplate, DisplayScreen, PreferenceProfile, PreferenceMediaItem } from '../types';
...
import { ChevronDownIcon, PencilIcon, TrashIcon, FacebookIcon, SparklesIcon } from './icons';
