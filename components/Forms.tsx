...
export const StyledInput: React.FC<{value: string; onChange: (e: React.ChangeEvent<HTMLInputElement>) => void; [x:string]: any;}> = 
    ({value, onChange, ...props}) => (
    <input value={value} onChange={onChange} {...props} className="w-full bg-slate-100 dark:bg-slate-900/50 p-2.5 rounded-lg border border-slate-300 dark:border-slate-600 focus:ring-2 focus:ring-primary focus:border-primary transition-colors"/>
);
...
export const StyledSelect: React.FC<{value: any; onChange: (e: React.ChangeEvent<HTMLSelectElement>) => void; children: React.ReactNode; [x:string]: any;}> = 
    ...
    <select value={value} onChange={onChange} {...props} className="w-full bg-slate-100 dark:bg-slate-900/50 p-2.5 rounded-lg border border-slate-300 dark:border-slate-600 focus:ring-2 focus:ring-primary focus:border-primary transition-colors h-[2.875rem]">
        {children}
    </select>
);
