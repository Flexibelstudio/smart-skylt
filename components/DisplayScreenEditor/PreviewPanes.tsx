...
const SinglePostPreview: React.FC<{ 
...
}> = ({ post, screen, organization, onUpdateTagPosition, onUpdateTextPosition }) => {
    ...
    return (
        <div className="space-y-4">
            ...
            <p className="text-xs text-slate-500 dark:text-gray-500 mt-2">Dra i text och taggar för att placera dem fritt.</p>
        </div>
    );
};
...
export const PreviewPane: React.FC<PreviewPaneProps> = ({ editingPost, screen, organization, onUpdateTagPosition, onUpdateTextPosition }) => {
    if (editingPost) {
        return (
            <SinglePostPreview
                post={editingPost}
