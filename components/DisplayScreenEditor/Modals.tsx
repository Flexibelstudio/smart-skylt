      ...
      {options.map((opt) => {
        ...
        return (
          <button
            ...
            className={`px-3.5 py-1.5 text-xs font-semibold rounded-full border transition-all duration-150 cursor-pointer shadow-sm ${
              isSelected
                ? 'bg-gradient-to-r from-purple-600 to-indigo-600 border-transparent text-white shadow-purple-500/20 shadow-md scale-[1.03]'
                : 'bg-white dark:bg-slate-800/65 border-slate-200 dark:border-slate-700/80 text-slate-600 dark:text-slate-300 hover:border-purple-300 dark:hover:border-purple-800 hover:text-purple-600 dark:hover:text-purple-400 hover:scale-[1.01]'
            }`}
          >
            {opt.label}
          </button>
