...
import { Page, MenuItem, Organization, CustomPage, UserRole, UserData, DisplayScreen, Tag, PostTemplate } from './types';
...
const AuthenticatedApp: React.FC = () => {
  ...
  }, [locationLoading, allOrganizations, selectOrganization, selectedOrganization]);
  ...
  const renderPage = () => {
      switch (page) {
          ...
          default:
              ...
              if (role === 'organizationadmin') return <SuperAdminScreen 
                  organization={selectedOrganization!}
                  adminRole={userData?.adminRole || 'admin'}
                  userRole={role}
                  theme={theme}
