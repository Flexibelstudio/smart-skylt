...
import { BellIcon, LoadingSpinnerIcon, LightBulbIcon, ChatBubbleLeftRightIcon } from './components/icons';
...
const MainContent: React.FC = () => {
  ...
  const handleReturnToAdminFromDisplay = () => {
    ...
    // FIX: Added 'onUpdateDisplayScreens' prop handler for SuperAdminScreen.
  ...
  return (
      <div className="min-h-screen flex flex-col bg-slate-100 dark:bg-slate-900">
          ...
          <button
            ...
            className={`fixed bottom-6 right-6 w-20 h-20 rounded-full shadow-lg transition-all flex items-center justify-center z-40 transform hover:scale-105 overflow-hidden ${isMarketingCoachOpen ? 'bg-slate-700 hover:bg-slate-600' : 'bg-blue-600 hover:bg-blue-500'}`}
            aria-label={isMarketingCoachOpen ? "Stäng AI-assistent" : "Öppna AI-assistent & Support"}
            title={isMarketingCoachOpen ? "Stäng AI-assistent" : "AI-assistent & Support"}
          >
            {isMarketingCoachOpen ? (
